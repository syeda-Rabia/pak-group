  ...
  const ModalDelete = ({ item }) => {
    ...
    return (
      ...
      >
        ...
        <div>
          <Modal.Body>Do you really want to delete this Home or office</Modal.Body>
          <Modal.Footer>
            <Button
              variant="secondary"
              onClick={() => {
    ...
    <Container fluid className="Laa">
      ...
      />
        ...
        <Col lg={10} sm={10} xs={10} xl={11}>
          <h3 style={{ color: "#818181" }}>Home And Offices</h3>
        </Col>
        </Row>
        ...
        <Row className=" shadow p-3  bg-white rounded ml-2 mr-1">
          ...
          >
            <FontAwesomeIcon icon={faPlusSquare} /> Add home
          </button>
